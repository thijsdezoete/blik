...
class Command(BaseCommand):
    ...
    async def _capture_screenshots(self, config, base_url, output_path):
        ...
        async with async_playwright() as p:
            ...
            screenshot_configs = [
                # 1. Report page with charts - Desktop Light (tall viewport to capture charts)
                {
                    'name': 'report_desktop_light',
                    'url': f'{base_url}/report/{config["completed_cycle_id"]}/',
                    'viewport': {'width': 1920, 'height': 2400},
                    'theme': 'light',
                    'scroll_to': 800,  # Scroll to charts section
                },
                # 2. Report page with charts - Desktop Dark (tall viewport to capture charts)
                {
                    'name': 'report_desktop_dark',
                    'url': f'{base_url}/report/{config["completed_cycle_id"]}/',
                    'viewport': {'width': 1920, 'height': 2400},
                    'theme': 'dark',
                    'scroll_to': 800,  # Scroll to charts section
                },
                # 3. Report page - Tablet Light
                {
                ...
                # 5. Admin Dashboard - Desktop Light
                {
                ...
                # 6. Admin Dashboard - Desktop Dark
                {
                ...
                # 7. Admin Dashboard - Mobile Light
                {
                ...
                # 9. Review Cycle Detail - Desktop Light
                {
                ...
                # 10. Review Cycle Detail - Desktop Dark
                {
                ...
                # 11. Team Management - Desktop Light
                {
                ...
                # 12. Team Management - Desktop Dark
                {
                ...
                # 13. Manage Invitations - Desktop Light
                {
            ...
            if feedback_token_str:
                feedback_configs = [
                    # 14. Feedback Form - Desktop Light
                    {
                ...
                for i, screenshot_config in enumerate(feedback_configs, len(screenshot_configs) + 1):
                    self.stdout.write(f'\n[{i}/{len(screenshot_configs) + len(feedback_configs)}] Capturing: {screenshot_config["name"]}')
