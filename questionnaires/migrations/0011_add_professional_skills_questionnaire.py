...
def load_professional_skills_questionnaire(apps, schema_editor):
    """
    Load Professional Skills 360 Review questionnaire from fixture.
    ...
    if existing:
        print("✓ Professional Skills 360 Review template already exists")
        questionnaire = existing
    else:
        # Load fixture data
        fixture_path = Path(__file__).parent.parent / 'fixtures' / 'professional_skills_questionnaire.json'
        ...
        print("✓ Created Professional Skills 360 Review template")
    ...
    if cloned_count > 0:
        print(f"✓ Cloned Professional Skills 360 Review to {cloned_count} organization(s)")
...
def reverse_professional_skills_questionnaire(apps, schema_editor):
    """Remove Professional Skills 360 Review questionnaire"""
    Questionnaire = apps.get_model('questionnaires', 'Questionnaire')
    ...
    if deleted_count > 0:
        print(f"Deleted {deleted_count} 'Professional Skills 360 Review' questionnaire(s)")


class Migration(migrations.Migration):

    dependencies = [
        ('questionnaires', '0010_ensure_software_engineering_questionnaire'),
        ('core', '0001_initial'),  # Need Organization model
    ]

    operations = [
        migrations.RunPython(
            load_professional_skills_questionnaire,
            reverse_professional_skills_questionnaire
        ),
    ]
